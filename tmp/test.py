...
def main():
    ...
    softmax_model = load_model('models/mnist_w2v_3d/model.hdf5')
    ...
    cosface_model = load_model('models/mnist_w2v_cosface_3d/model.hdf5', custom_objects={'CosFace': CosFace})
    ...
    arcface_model = load_model('models/mnist_w2v_arcface_3d/model.hdf5', custom_objects={'ArcFace': ArcFace})
    ...
    sphereface_model = load_model('models/mnist_w2v_sphereface_3d/model.hdf5', custom_objects={'SphereFace': SphereFace})
